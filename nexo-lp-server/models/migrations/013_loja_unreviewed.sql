-- ============================================================
-- Migration 013: LOJA Unreviewed Templates
-- Adds support for templates that failed QA review and are sold
-- at a discounted price until they are properly sanitized/reviewed.
-- ============================================================
...
CREATE TABLE templates_new (
    ...
    status TEXT NOT NULL DEFAULT 'available'
        CHECK (status IN ('sanitizing', 'available', 'failed', 'unreviewed')),
    original_html TEXT,
    sanitized_html TEXT,
